...
describe('REST API test', function () {
    ...
    describe('Challenge lifecycle', function () {
        ...
        it('should show one challenge', function (done) {
            request(app)
        ...
        it('should update one challenge', function (done) {
    ...
    describe("Deny unauthenticated and unauthorized access", function () {
        ...
        before(function () {
            //create test challenge, maybe another test user to check if authorization works properly
        });

        it("should deny unauthenticated challenge creating", function (done) {
            request(app)
                .post("/api/movies")
                .send(testmovie)
                .expect(401)
